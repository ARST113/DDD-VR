...
bool OpenXrSwapchain::create(XrSession session, int32_t w, int32_t h) {
    ...
    int64_t chosen = 0; std::vector<int64_t> pref = {GL_SRGB8_ALPHA8, GL_RGBA16F, GL_RGB10_A2, GL_RGBA8, 0x8058};
...
void OpenXrSwapchain::destroy() { if (swapchain_ != XR_NULL_HANDLE) { xrDestroySwapchain(swapchain_); swapchain_ = XR_NULL_HANDLE; } format_ = 0; }
